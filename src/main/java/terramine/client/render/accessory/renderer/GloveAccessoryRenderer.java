...
public class GloveAccessoryRenderer implements AccessoryRenderer {
    ...
    public GloveAccessoryRenderer(String name, ArmsModel defaultModel, ArmsModel slimModel, boolean noSlim) {
        this(String.format("glove/%s/%s", name, name), String.format("glove/%s/%s", name, name), defaultModel, slimModel);
    }
