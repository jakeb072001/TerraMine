...
import terramine.client.render.accessory.renderer.BeltCurioRenderer;
import terramine.client.render.accessory.renderer.GloveCurioRenderer;
import terramine.client.render.accessory.renderer.GlowingGloveCurioRenderer;
...
public class CurioRenderers implements SimpleSynchronousResourceReloadListener {
    ...
    public void onResourceManagerReload(@NotNull ResourceManager resourceManager) {
        ...
        // belt
        AccessoryRenderRegistry.registerRenderer(ModItems.CLOUD_IN_A_BOTTLE, new BeltCurioRenderer("cloud_in_a_bottle", BeltModel.createCloudInABottleModel()));
        AccessoryRenderRegistry.registerRenderer(ModItems.OBSIDIAN_SKULL, new BeltCurioRenderer("obsidian_skull", BeltModel.createObsidianSkullModel()));
        AccessoryRenderRegistry.registerRenderer(ModItems.TREASURE_MAGNET, new BeltCurioRenderer("universal_attractor", BeltModel.createUniversalAttractorModel()));

        // hands
        AccessoryRenderRegistry.registerRenderer(ModItems.FERAL_CLAWS, new GloveCurioRenderer("claws/feral_claws", "claws/feral_claws", ArmsModel.createClawsModel(false), ArmsModel.createClawsModel(true)));
        AccessoryRenderRegistry.registerRenderer(ModItems.POWER_GLOVE, new GloveCurioRenderer("power_glove", ArmsModel.createGloveModel(false), ArmsModel.createGloveModel(true)));
        AccessoryRenderRegistry.registerRenderer(ModItems.FIRE_GAUNTLET, new GlowingGloveCurioRenderer("fire_gauntlet", ArmsModel.createGloveModel(false), ArmsModel.createGloveModel(true)));
