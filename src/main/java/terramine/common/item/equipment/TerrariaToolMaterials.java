...
public record TerrariaToolMaterials() {
    ...
    static {
        ...
        SILVER = new ToolMaterial(BlockTags.INCORRECT_FOR_GOLD_TOOL,370, 7f, 2.5f, 16, ModTags.REPAIRS_SILVER_ARMOR);
        TUNGSTEN = new ToolMaterial(BlockTags.INCORRECT_FOR_GOLD_TOOL,370, 7f, 2.5f, 16, ModTags.REPAIRS_TUNGSTEN_ARMOR);
        PLATINUM = new ToolMaterial(BlockTags.INCORRECT_FOR_GOLD_TOOL,64, 12.0F, 0.0F, 22, ModTags.REPAIRS_PLATINUM_ARMOR);
        DEMONITE = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL,500, 8f, 3f, 18, ModTags.REPAIRS_SHADOW_ARMOR);
        CRIMTANE = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL,500, 7.5f, 3.5f, 18, ModTags.REPAIRS_CRIMSON_ARMOR);
        METEOR = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL,1800, 9f, 4.0f, 18, ModTags.REPAIRS_METEOR_ARMOR);
