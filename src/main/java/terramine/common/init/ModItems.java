...
public class ModItems {
	...
	public static final Item PHASEBLADE_WHITE = register("phaseblade_white", new CustomSoundSwordItem(TerrariaToolTiers.METEOR, 3, -1f, ModSoundEvents.PHASEBLADE_SWING, new FabricItemSettings().group(TerraMine.ITEM_GROUP_EQUIPMENT)));
	public static final Item PHASEBLADE_GREEN = register("phaseblade_green", new CustomSoundSwordItem(TerrariaToolTiers.METEOR, 3, -1f, ModSoundEvents.PHASEBLADE_SWING, new FabricItemSettings().group(TerraMine.ITEM_GROUP_EQUIPMENT)));
	...
	// Bombs
	public static final Item BOMB = register("bomb", new BombItem(new FabricItemSettings().group(TerraMine.ITEM_GROUP_THROWABLES), false, false));
	public static final Item STICKY_BOMB = register("sticky_bomb", new BombItem(new FabricItemSettings().group(TerraMine.ITEM_GROUP_THROWABLES), true, false));
	public static final Item BOUNCY_BOMB = register("bouncy_bomb", new BombItem(new FabricItemSettings().group(TerraMine.ITEM_GROUP_THROWABLES), false, true));
	// Dynamite
	...
	public static final Item RAW_METEORITE_BLOCK = register("raw_meteorite_block", new BlockItem(ModBlocks.RAW_METEORITE_BLOCK, new FabricItemSettings().group(TerraMine.ITEM_GROUP_BLOCKS)));
	public static final Item METEORITE_BLOCK = register("meteorite_block", new BlockItem(ModBlocks.METEORITE_BLOCK, new FabricItemSettings().group(TerraMine.ITEM_GROUP_BLOCKS)));
