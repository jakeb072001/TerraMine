...
public class ModBlocks {
    ...
    public static final Block RAW_HELLSTONE_BLOCK = register("raw_hellstone_block", new HotFloorBlock(Properties.copy(Blocks.MAGMA_BLOCK).destroyTime(10f).explosionResistance(1200f), false));
