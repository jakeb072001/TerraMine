...
public class ModBiomeFeatures {
    ...
    public static void addDefaultCrimsonOres(BiomeGenerationSettings.Builder builder) {
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, ModBiomeFeatures.ORE_CRIMTANE_UPPER);
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, ModBiomeFeatures.ORE_CRIMTANE_MIDDLE);
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, ModBiomeFeatures.ORE_CRIMTANE_SMALL);
    }
