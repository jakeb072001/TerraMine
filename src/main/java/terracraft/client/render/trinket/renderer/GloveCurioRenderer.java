...
public class GloveCurioRenderer implements TrinketRenderer {
    ...
    public GloveCurioRenderer(String defaultTexturePath, String slimTexturePath, ArmsModel defaultModel, ArmsModel slimModel) {
        this.defaultTexture = TerraCraft.id(String.format("textures/entity/curio/%s.png", defaultTexturePath));
        this.slimTexture = TerraCraft.id(String.format("textures/entity/curio/%s.png", slimTexturePath));
