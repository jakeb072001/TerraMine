...
public class GlowingGloveCurioRenderer extends GloveCurioRenderer {
    ...
    public GlowingGloveCurioRenderer(String name, ArmsModel defaultModel, ArmsModel slimModel) {
        ...
        defaultGlowTexture = TerraCraft.id(String.format("textures/entity/curio/glove/%s/%s_default_glow.png", name, name));
        slimGlowTexture = TerraCraft.id(String.format("textures/entity/curio/glove/%s/%s_slim_glow.png", name, name));
    }
