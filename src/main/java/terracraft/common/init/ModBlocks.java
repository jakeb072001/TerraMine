...
public class ModBlocks {
    ...
    public static final Block SKYWARE_CHEST = register("skyware_chest", new SkywareChestBlock(FabricBlockSettings.of(Material.METAL, MaterialColor.LAPIS).strength(3.0f, 6.0f).sounds(SoundType.METAL), false, () -> ModBlockEntityType.SKYWARE_CHEST));
