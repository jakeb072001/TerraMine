...
public class Artifacts implements ModInitializer, TerraBlenderApi {
	...
	public static final AttributeModifier KNOCKBACK_RESISTANCE_COBALT_MODIFIER = new AttributeModifier(UUID.fromString("7e97cede-a243-468f-b415-14bff6da3666"),
			"artifacts:cobalt_shield_knockback_resistance", 1, AttributeModifier.Operation.ADDITION);
	public static final AttributeModifier KNOCKBACK_RESISTANCE_OBSIDIAN_MODIFIER = new AttributeModifier(UUID.fromString("5e97cada-a242-465f-b425-13bfd6db3676"),
			"artifacts:obsidian_shield_knockback_resistance", 1, AttributeModifier.Operation.ADDITION);
	public static final AttributeModifier ARMOR_ADD_ONE = new AttributeModifier(UUID.fromString("2e97c2de-a2d3-4a8f-b415-14bff6da3666"),
			"artifacts:cobalt_shield_armor_two", 1, AttributeModifier.Operation.ADDITION);
	public static final AttributeModifier ARMOR_ADD_TWO = new AttributeModifier(UUID.fromString("1a93aedf-a243-4d8f-b415-14bff6da3666"),
			"artifacts:cobalt_shield_armor_one", 2, AttributeModifier.Operation.ADDITION);
	public static final CreativeModeTab ITEM_GROUP = FabricItemGroupBuilder.build(
			id("item_group"),
			() -> new ItemStack(Items.TERRASPARK_BOOTS)
	);
	...
	public void onInitialize() {
		...
		Potions.LESSER_MANA_POTION.toString();
		Stats.CUSTOM.get(Statistics.MANA_USED, StatFormatter.DEFAULT);
		Features.register();
		Biomes.registerAll();
		ModProfessions.fillTradeData();

		Registry.register(Registry.PARTICLE_TYPE, Artifacts.id("blue_poof"), BLUE_POOF);
		Registry.register(Registry.PARTICLE_TYPE, Artifacts.id("green_spark"), GREEN_SPARK);
