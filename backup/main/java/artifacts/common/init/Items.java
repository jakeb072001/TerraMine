...
public class Items {
	...
	public static final Item DEMON_EYE_SPAWN_EGG = register("demon_eye_spawn_egg", new SpawnEggItem(Entities.DEMON_EYE, 0xffffff, 0xff0000, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	...
	public static final Item COBALT_SHIELD = register("cobalt_shield", new FabricShieldItem(new FabricItemSettings().maxDamage(2500).fireproof().rarity(Rarity.RARE).group(Artifacts.ITEM_GROUP), 10, 13, net.minecraft.world.item.Items.DIAMOND)); // FabricShieldItem(settings.maxDamage(durability), cooldownTicks, enchantability, repairItem)
	public static final Item OBSIDIAN_SHIELD = register("obsidian_shield", new FabricShieldItem(new FabricItemSettings().maxDamage(2500).fireproof().rarity(Rarity.RARE).group(Artifacts.ITEM_GROUP), 10, 13, net.minecraft.world.item.Items.OBSIDIAN));
	...
	// Informational
	public static final Item GOLD_WATCH = register("gold_watch", new TrinketArtifactItem());
	public static final Item DEPTH_METER = register("depth_meter", new TrinketArtifactItem());
	public static final Item COMPASS = register("compass", new TrinketArtifactItem());
	public static final Item GPS = register("gps", new TrinketArtifactItem());
	public static final Item WEATHER_RADIO = register("weather_radio", new TrinketArtifactItem());
	public static final Item SEXTANT = register("sextant", new TrinketArtifactItem());
	public static final Item FISH_FINDER = register("fish_finder", new TrinketArtifactItem());
	public static final Item METAL_DETECTOR = register("metal_detector", new TrinketArtifactItem());
	public static final Item STOPWATCH = register("stopwatch", new TrinketArtifactItem());
	public static final Item DPS_METER = register("dps_meter", new TrinketArtifactItem());
	public static final Item GOBLIN_TECH = register("goblin_tech", new TrinketArtifactItem());
	public static final Item PDA = register("pda", new TrinketArtifactItem());
	...
	public static final Item RANGER_EMBLEM = register("ranger_emblem", new TrinketArtifactItem());
	public static final Item WARRIOR_EMBLEM = register("warrior_emblem", new WarriorEmblemItem());
	public static final Item SORCERER_EMBLEM = register("sorcerer_emblem", new TrinketArtifactItem());
	...
	public static final Item OBSIDIAN_ROSE = register("obsidian_rose", new TrinketArtifactItem());
	public static final Item MAGMA_STONE = register("magma_stone", new TrinketArtifactItem());
	...
	public static final Item LUCKY_HORSESHOE = register("lucky_horseshoe", new TrinketArtifactItem());
	public static final Item OBSIDIAN_HORSESHOE = register("obsidian_horseshoe", new TrinketArtifactItem());
	...
	// Hands
	public static final Item SHOE_SPIKES = register("shoe_spikes", new TrinketArtifactItem());
	public static final Item CLIMBING_CLAWS = register("climbing_claws", new TrinketArtifactItem());
	public static final Item TIGER_CLIMBING_GEAR = register("tiger_climbing_gear", new TrinketArtifactItem());
	public static final Item TABI = register("tabi", new TabiItem());
	public static final Item BLACK_BELT = register("black_belt", new TrinketArtifactItem());
	...
	public static final Item ICE_SKATES = register("ice_skates", new TrinketArtifactItem());
