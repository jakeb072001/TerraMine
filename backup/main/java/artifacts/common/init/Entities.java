...
public class Entities {
	...
	public static final EntityType<DemonEyeEntity> DEMON_EYE = Registry.register( Registry.ENTITY_TYPE, Artifacts.id("demon_eye"),
			FabricEntityTypeBuilder.create(MobCategory.MISC, DemonEyeEntity::new)
					.dimensions(EntityDimensions.fixed(0.25f, 0.25f))
					.spawnGroup(MobCategory.MONSTER)
					.build());

	public static final EntityType<FallingStarEntity> FALLING_STAR = Registry.register( Registry.ENTITY_TYPE, Artifacts.id("falling_star"),
			FabricEntityTypeBuilder.create(MobCategory.MISC, FallingStarEntity::new)
					.dimensions(EntityDimensions.fixed(0.25f, 0.25f))
					.build());

	public static final EntityType<MagicMissileEntity> MAGIC_MISSILE = Registry.register( Registry.ENTITY_TYPE, Artifacts.id("magic_missile"),
