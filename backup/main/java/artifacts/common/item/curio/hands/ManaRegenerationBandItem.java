...
public class ManaRegenerationBandItem extends TrinketArtifactItem {

	@Override
	public void onEquip(ItemStack stack, SlotReference slot, LivingEntity entity) {
		Player player = (Player)entity;
		Components.MANA_HANDLER.get(player).addMaxMana(20);
		Components.MANA_HANDLER.get(player).setManaBonus(25, true);
	}
	...
	public void onUnequip(ItemStack stack, SlotReference slot, LivingEntity entity) {
		...
		Components.MANA_HANDLER.get(player).setManaBonus(0, false);
	}
}
